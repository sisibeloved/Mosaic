...
当前版本 **v0.1.0**（2026-09-16，版本历史的起点，见 [CHANGELOG](CHANGELOG.md)）：核心讨论闭环、收束与记忆、产品化功能面（M0–M4）已完成并验收。后续版本规划：

- **0.2.0 协作文档**：全局文档资产落地——块级 Markdown 文档、消息卡片、群文档与 agent `doc_ops`，文档可跨房间引用续作（[RFC-0014](docs/design/rfc/2026-09-16-rfc-0014-documents.md)）。
- **0.3.0 Agent 兼容性扩充**：新增 ZCode（待上游解除阻塞）、Claude Code 等 Harness 适配器，扩大自动发现与登录探测的覆盖渠道。
